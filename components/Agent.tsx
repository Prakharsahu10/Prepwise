  ...
  useEffect(() => {
    ...
    const handleGenerateFeedback = async (messages: SavedMessage[]) => {
      ...
      try {
        ...
        if (success && id) {
          console.log(
            "Feedback created successfully, redirecting to",
  ...
  const handleCall = async () => {
    try {
      ...
      if (type === "generate") {
        ...
        if (!workflowId) {
          console.error("Missing VAPI workflow ID in environment variables");
        ...
        console.log("Starting interview call with questions");
